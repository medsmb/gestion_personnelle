...
Public Class saisie_de_paie
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "gestion_personnelle_2013.saisie_de_paie.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedsaisie_de_paie
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As saisie_de_paie = New saisie_de_paie
        rpt.Site = Me.Site
        Return rpt
    End Function
